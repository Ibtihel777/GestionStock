...
function EmplacementList() {
  ...
  return (
    <section className="entity-section" aria-labelledby="emplacements-title">
      <div className="entity-list-header"><div><h2 id="emplacements-title">Emplacements</h2><p>Organisez les zones de stockage.</p></div><button type="button" onClick={() => { setEmplacementToEdit(null); setActionError(null); setIsFormOpen(true); }}>Nouvel emplacement</button></div>
