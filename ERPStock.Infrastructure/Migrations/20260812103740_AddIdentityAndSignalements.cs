...
{
    /// <inheritdoc />
    public partial class AddIdentityAndSignalements : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignaleParUserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    SignalePar = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Signalements_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Signalements_Emplacements_EmplacementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Signalements_ArticleId",
                table: "Signalements",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_Signalements_EmplacementId",
                table: "Signalements",
